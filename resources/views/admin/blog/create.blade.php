                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/blog/{{ (!empty($post) ? $post->id.'/update' : 'store') }}" method="post">
                                ...
                                <div class="form-group mt-15">
                                    ...
                                    <textarea rows="4" name="description" class="form-control @error('description')  is-invalid @enderror" placeholder="{{ trans('admin/main.description_placeholder') }}">{!! !empty($post) ? $post->description : old('description')  !!}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
