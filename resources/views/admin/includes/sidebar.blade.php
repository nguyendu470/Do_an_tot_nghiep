<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @can('admin_comments')
                <li
                    class="nav-item dropdown {{ (request()->is('admin/comments*') and !request()->is('admin/comments/webinars/reports')) ? 'active' : '' }}">
            ...
            {{-- tin nhắn liên hệ trang contacts --}}
            @can('admin_contacts')
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_noticeboards_list')
                            <li class="{{ request()->is('admin/noticeboards') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/noticeboards">{{ trans('admin/main.notices_list_title') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_noticeboards_send')
                            <li class="{{ request()->is('admin/noticeboards/send') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/noticeboards/send">{{ trans('admin/main.new_notice_title') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_blog')
                <li
                    class="nav-item dropdown {{ (request()->is('admin/blog*') and !request()->is('admin/blog/comments')) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_additional_pages_contact_us')
                            <li class="{{ request()->is('admin/additional_page/contact_us') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/additional_page/contact_us">{{ trans('admin/main.contact_us') }}</a>
                            </li>
                        @endcan()
                        ...
                        {{-- @can('admin_additional_pages_navbar_links')
                            <li class="{{ request()->is('admin/additional_page/navbar_links') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/additional_page/navbar_links">{{ trans('admin/main.top_navbar') }}</a>
                            </li>
                        @endcan() --}}
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_subscribe_list')
                            <li class="{{ request()->is('admin/financial/subscribes') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/financial/subscribes">{{ trans('admin/main.packages') }}</a>
                            </li>
                        @endcan
            ...
            @can('admin_settings')
                @php
                    ...
                    if (request()->is('admin/settings*') and !(request()->is('admin/settings/404') or request()->is('admin/settings/contact_us') or request()->is('admin/settings/footer') or request()->is('admin/settings/navbar_links'))) {
                        $settingClass = 'active';
                    }
                @endphp
