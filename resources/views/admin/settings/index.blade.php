...
@section('content')
	{{-- 2c9921d4-7254-45b5-a665-199fcf02b5f8 --}}
                    ...
                    <div class="col-lg-6">
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/admin/settings/personalization" class="card-cta">{{ trans('admin/main.change_setting') }}<i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                @endcan
