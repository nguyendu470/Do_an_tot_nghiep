                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="/admin/webinars/{{ !empty($webinar) ? $webinar->id.'/update' : 'store' }}" id="webinarForm" class="webinar-form">
                                ...
                                {{-- gói định giá mới để giảm giá --}}
                                    ...
                                    <section class="mt-30">
                                        ...
                                        <div class="row mt-10">
                                            <div class="col-12">
                                                @if(!empty($chapers) and !$chapers->isEmpty())
                                                    <div class="table-responsive">
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($chapers as $chap)
                                                                <tr>
                                                                    <th>{{ $chap->title }}</th>

                                                                    <td>
                                                                        <button type="button" data-chap-id="{{ $chap->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-chap btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        @include('admin.includes.delete_button',['url' => '/admin/files/'. $chap->id .'/delete_chap', 'btnClass' => ' mt-1'])
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="webinarAddFile" type="button" class="btn btn-primary btn-sm mt-3 mr-3">{{ trans('public.add_files') }}</button>
                                    ...
                                    @if($webinar->isTextCourse())
                                        <section class="mt-30">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <button id="webinarAddTestLesson" type="button" class="btn btn-primary btn-sm mt-3 mr-3">{{ trans('public.add_test_lesson') }}</button>
                                                            ...
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                @foreach($textLessons as $textLesson)
                                                                    <tr>
                                                                        ...
                                                                        <th>{{ $textLesson->chap()->first()->title??"--" }}</th>
                            ...
                            @include('admin.webinars.modals.chap')
                            @include('admin.webinars.modals.importFile')
                            @include('admin.webinars.modals.importText')
...
@push('scripts_bottom')
    ...
    <script src="/assets/admin/js/webinar.min.js?v={{time()}}"></script>
@endpush
