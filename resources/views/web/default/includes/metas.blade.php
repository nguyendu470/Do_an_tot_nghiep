...
<meta property='og:image' content='{{ !empty($image_seo)?$image_seo:url(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '') }}'>
<meta name='twitter:image' content='{{ !empty($image_seo)?$image_seo:url(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '') }}'>
