        ...
        <figcaption class="webinar-card-body">
            ...
            <div class="webinar-price-box mt-25">
                @if(!empty($webinar->price) and $webinar->price > 0)
                    @if($webinar->bestTicket() < $webinar->price)
                        <span class="real">{{ number_format($webinar->bestTicket(),0,",",".") }}{{ $currency }}</span>
                        <span class="off ml-10">{{ number_format($webinar->price,0,",",".") }}{{ $currency }}</span>
                    @else
                        <span class="real">{{ number_format($webinar->price,0,",",".") }}{{ $currency }}</span>
                    @endif
                @else
