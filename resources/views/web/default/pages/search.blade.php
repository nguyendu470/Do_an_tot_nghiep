                    ...
                    <div class="row">
                        @foreach ($webinars as $webinar)
                            <div class="col-md-6 col-lg-4 mt-30">
                                @include(getTemplate() . '.includes.webinar.grid-card', [
                                    'webinar' => $webinar,
                                ])
                            </div>
                        @endforeach
                            ...
                            <div class="col-6 col-md-3 col-lg-2 mt-30">
                                <div
                                    ...
                                    <div class="user-avatar">
                                        <img src="{{ $teacher->getAvatar() }}" class="img-cover rounded-circle"
                                            alt="{{ $teacher->full_name }}">
                                    </div>
                                    <a href="{{ $teacher->getProfileUrl() }}">
                                        <h4 class="font-16 font-weight-bold text-dark-blue mt-10">{{ $teacher->full_name }}
                                        </h4>
                            ...
                            <div class="col-md-6 col-lg-3 mt-30">
                                <a href="{{ $organization->getProfileUrl() }}"
                                    ...
                                    <div class="home-organizations-avatar">
                                        <img src="{{ $organization->getAvatar() }}" class="img-cover rounded-circle"
