...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'web'], function () {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'files'], function () {
            ...
            Route::post('/store_chap', 'FileController@store_chap');
            ...
            Route::post('/{id}/edit_chap', 'FileController@edit_chap');
            Route::post('/{id}/update_chap', 'FileController@update_chap');
            Route::get('/{id}/delete_chap', 'FileController@destroy_chap');
        ...
        Route::group(['prefix' => 'test-lesson'], function () {
            ...
            Route::post('/import', 'TextLessonsController@import');
        });
