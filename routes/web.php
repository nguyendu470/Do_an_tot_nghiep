...
Route::group(['namespace' => 'Auth', 'middleware' => ['share']], function () {
    Route::get('/login', 'LoginController@showLoginForm')->name('dangnhap');
    Route::post('/login', 'LoginController@login');
    Route::get('/logout', 'LoginController@logout');
    Route::get('/register', 'RegisterController@showRegistrationForm');
    //  Route::post('/dangki', 'RegisterController@dangki');
...
Route::group(['namespace' => 'Web', 'middleware' => ['impersonate', 'share']], function () {
    ...
    Route::group(['prefix' => 'course'], function () {
        ...
        Route::get('/{slug}/lessons/{lesson_id}/watch', 'WebinarController@getLessonFile');
    });
