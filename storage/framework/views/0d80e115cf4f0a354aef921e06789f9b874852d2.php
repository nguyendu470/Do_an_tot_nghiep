                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header flex-column align-items-start">
                            <h4><?php echo e(trans('admin/main.user_name')); ?>: <span class="text-black-50"><?php echo e($contact->name); ?></span></h4>
                            <h4><?php echo e(trans('admin/main.email')); ?> : <span class="text-black-50"><?php echo e($contact->email); ?></span></h4>
                            <h4><?php echo e(trans('admin/main.phone')); ?> : <span class="text-black-50"><?php echo e($contact->phone); ?></span></h4>
                            <h4><?php echo e(trans('site.message')); ?> :</h4>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/contacts/reply.blade.php ENDPATH**/ ?>