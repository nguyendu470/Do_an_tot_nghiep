...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e($currency); ?><?php echo e($accountCharge ?? 0); ?></strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e($currency); ?><?php echo e($readyPayout ?? 0); ?></strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e($currency); ?><?php echo e($totalIncome ?? 0); ?></strong>
    ...
    <section class="mt-30">
        ...
        <form action="/panel/financial/<?php echo e(!empty($editOfflinePayment) ? 'offline-payments/'. $editOfflinePayment->id .'/update' : 'charge'); ?>" method="post" class="mt-25">
                    ...
                    <div class="col-12 col-lg-3 mb-25 mb-lg-0 js-offline-payment-input " style="<?php echo e((!$showOfflineFields) ? 'display:none' : ''); ?>">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="date" value="<?php echo e(!empty($editOfflinePayment) ? $editOfflinePayment->pay_date : old('date')); ?>" class="form-control datetimepicker <?php $__errorArgs = ['date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/panel/financial/account.blade.php ENDPATH**/ ?>