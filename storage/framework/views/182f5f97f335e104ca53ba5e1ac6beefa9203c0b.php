...
<meta property='og:image' content='<?php echo e(!empty($image_seo)?$image_seo:url(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '')); ?>'>
<meta name='twitter:image' content='<?php echo e(!empty($image_seo)?$image_seo:url(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '')); ?>'>
<meta property='og:locale' content='<?php echo e(url(!empty($generalSettings['locale']) ? $generalSettings['locale'] : 'en_US')); ?>'>
<meta property='og:type' content='website'>

<?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/includes/metas.blade.php ENDPATH**/ ?>