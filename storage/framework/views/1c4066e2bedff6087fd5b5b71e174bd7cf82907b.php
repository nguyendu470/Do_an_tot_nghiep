...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">VnEdumall.com</h1>
                <h5 class="font-weight-normal text-muted-transparent">nền tảng giáo dục đầy đủ tính năng</h5>
              </div>
              Tất cả các quyền được bảo lưu cho <a class="text-light bb" target="_blank" href="https://vnedumall.com">VnEdumall.com</a> và <a class="text-light bb" target="_blank" href="https://vnedumall.vn">VnEdumall.vn</a>
            </div>
          </div>
            </div>
...
<?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>