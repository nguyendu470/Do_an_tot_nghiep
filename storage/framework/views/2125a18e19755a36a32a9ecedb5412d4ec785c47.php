                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_become_instructors_reject')): ?>
                                                    <?php if($become->status != 'accept'): ?>
                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/users/become_instructors/'. $become->id .'/reject' , 'btnClass' => 'mr-1', 'btnIcon' => 'fa-check','tooltip' => trans('admin/main.reject_request')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    <?php endif; ?>
                                                <?php endif; ?>

                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_become_instructors_delete')): ?>
                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/users/become_instructors/'. $become->id .'/delete' , 'btnClass' => '','tooltip' => trans('admin/main.delete')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                        ...
                        <div class="card-footer text-center">
                            <?php echo e($becomeInstructors->links()); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/users/become_instructors/lists.blade.php ENDPATH**/ ?>