        ...
        <div class="d-flex justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <span class="date-published ml-5 font-14"><?php echo e(dateTimeFormat(!empty($webinar->start_date) ? $webinar->start_date : $webinar->created_at,'j F Y')); ?></span>
                </div>
            </div>
            ...
            <div class="webinar-price-box d-flex flex-column justify-content-center align-items-center">
                <?php if(!empty($webinar->price) and $webinar->price > 0): ?>
                    <?php if($webinar->bestTicket() < $webinar->price): ?>
                        <span class="off"><?php echo e($currency); ?><?php echo e(number_format($webinar->price,0,",",".")); ?></span>
                        <span class="real"><?php echo e($currency); ?><?php echo e(number_format($webinar->bestTicket(),0,",",".")); ?></span>
                    <?php else: ?>
                        <span class="real"><?php echo e($currency); ?><?php echo e(number_format($webinar->price,0,",",".")); ?></span>
                    <?php endif; ?>
                <?php else: ?>
...
<?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/web/default/includes/webinar/list-card.blade.php ENDPATH**/ ?>