                                    ...
                                    <?php if($documents->count() > 0): ?>
                                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="text-left">
                                                    <div class="text-left">
                                                        <?php if(!empty($document->webinar_id)): ?>
                                                            ...
                                                            <a href="<?php echo e($document->webinar->getUrl()); ?>"
                                                               target="_blank" class="font-12">#<?php echo e($document->webinar_id); ?>-<?php echo e($document->webinar->title); ?></a>
                                                        <?php elseif(!empty($document->meeting_time_id)): ?>
                                                            <span class="d-block font-weight-bold"><?php echo e(trans('admin/main.item_purchased')); ?></span>
                                                            <a href=""
                                                               target="_blank" class="font-12">#<?php echo e($document->meeting_time_id); ?> <?php echo e(trans('admin/main.meeting')); ?></a>
                                                        ...
                                                        <?php elseif($document->store_type == \App\Models\Accounting::$storeManual): ?>
                                                            <span class="d-block font-weight-bold"><?php echo e(trans('admin/main.manual_document')); ?></span>
                                                        <?php else: ?>
                                                ...
                                                <td class="text-left">
                                                    <?php if($document->user_id): ?>
                                                        <a href="/admin/users/<?php echo e($document->user_id); ?>/edit" target="_blank"
                                                ...
                                                <td>
                                                    <span class="text-success"><?php echo e($currency); ?><?php echo e(number_format($document->amount, 2, ".", "")+0); ?></span>
                                                </td>
                                                ...
                                                <td width="20%">
                                                    <?php echo e($document->type_account); ?>
                                                ...
                                                <td>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_documents_print')): ?>
                                                        <a href="/admin/financial/documents/<?php echo e($document->id); ?>/print" class="btn-sm fa fa-print"></a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/financial/documents/lists.blade.php ENDPATH**/ ?>