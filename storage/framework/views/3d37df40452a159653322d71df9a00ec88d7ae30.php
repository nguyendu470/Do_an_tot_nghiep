    ...
    <div class="course-reviews-box row align-items-center">
        ...
        <div class="col-9">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <span class="ml-15 font-14 text-gray"><?php echo e(trans('product.content_quality')); ?> (<?php echo e($course->reviews->count() > 0 ? round($course->reviews->avg('content_quality'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center justify-content-between">
                ...
                <span class="ml-15 font-14 text-gray"><?php echo e(trans('product.instructor_skills')); ?> (<?php echo e($course->reviews->count() > 0 ? round($course->reviews->avg('instructor_skills'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center justify-content-between">
                ...
                <span class="ml-15 font-14 text-gray"><?php echo e(trans('product.purchase_worth')); ?> (<?php echo e($course->reviews->count() > 0 ? round($course->reviews->avg('purchase_worth'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center justify-content-between">
                ...
                <span class="ml-15 font-14 text-gray"><?php echo e(trans('product.support_quality')); ?> (<?php echo e($course->reviews->count() > 0 ? round($course->reviews->avg('support_quality'), 1) : 0); ?>)</span>
            </div>
                ...
                <div class="comments-card shadow-lg rounded-sm border px-20 py-15 mt-30" data-address="/reviews/store-reply-comment" data-csrf="<?php echo e(csrf_token()); ?>" data-id="<?php echo e($review->id); ?>">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <span class="font-12 text-gray mr-10"><?php echo e(dateTimeFormat($review->created_at, 'Y M j | H:i')); ?></span>
                            ...
                            <div class="btn-group dropdown table-actions">
                                ...
                                <div class="dropdown-menu">
                                    <a href="/reviews/store-reply-commnet" class="webinar-actions d-block text-hover-primary reply-comment"><?php echo e(trans('panel.reply')); ?></a>
                                    <a href="" class="webinar-actions d-block mt-10 text-hover-primary"><?php echo e(trans('panel.report')); ?></a>
                        ...
                        <?php $__currentLoopData = $review->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="shadow-lg rounded-sm border px-20 py-15 mt-30">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="font-12 text-gray mr-10"><?php echo e(dateTimeFormat($comment->created_at, 'Y M j | H:i')); ?></span>
...
<?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/course/tabs/reviews.blade.php ENDPATH**/ ?>