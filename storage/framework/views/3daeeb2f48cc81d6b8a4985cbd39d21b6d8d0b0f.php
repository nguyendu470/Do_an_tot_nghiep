...
<?php $__env->startSection('content'); ?>
    <section class="cart-banner position-relative text-center">
        ...
        <span class="payment-hint font-20 text-white d-block"><?php echo e('$' . $total . ' ' .  trans('cart.for_items',['count' => $count])); ?></span>
    </section>
    ...
    <section class="container mt-45">
        ...
        <form action="/payments/payment-request" method="post" class=" mt-25">
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-4 mb-40 charge-account-radio">
                    ...
                    <label for="offline" class="rounded-sm p-20 p-lg-45 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <span class="mt-5"><?php echo e($currency); ?><?php echo e($userCharge); ?></span>
                    </label>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-45">
                <span class="font-16 font-weight-500 text-gray"><?php echo e(trans('financial.total_amount')); ?> <?php echo e($currency); ?><?php echo e($total); ?></span>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/cart/payment.blade.php ENDPATH**/ ?>