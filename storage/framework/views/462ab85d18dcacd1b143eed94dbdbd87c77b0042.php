    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="/admin/roles"><?php echo e(trans('admin/main.roles')); ?></a>
                </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/roles/<?php echo e(!empty($role) ? $role->id.'/update' : 'store'); ?>" method="Post">
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php endif; ?>
                                            <input type="<?php echo e(!empty($role) ? 'hidden' : 'text'); ?>" name="name" class="form-control"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group <?php echo e((!empty($role) && $role->is_admin) ? '' :'d-none'); ?>" id="sections">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>