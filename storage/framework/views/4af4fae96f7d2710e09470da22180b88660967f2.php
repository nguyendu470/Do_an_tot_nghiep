                        ...
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_feature_webinars_export_excel')): ?>
                                <div class="text-right">
                                    <a href="/admin/webinars/features/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo e(dateTimeFormat($feature->updated_at, 'Y M j | H:i')); ?></td>
                                            ...
                                            <td>
                                                <a href="/admin/webinars/features/<?php echo e($feature->id); ?>/<?php echo e(($feature->status == 'publish') ? 'pending' : 'publish'); ?>" class="btn-transparent btn-sm text-primary">
                                                ...
                                                <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/webinars/features/'. $feature->id .'/delete','btnClass' => 'btn-sm','icon' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/webinars/feature/lists.blade.php ENDPATH**/ ?>