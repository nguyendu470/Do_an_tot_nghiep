                ...
                <?php if(!empty($activeSpecialOffer)): ?>
                    <div class="d-flex align-items-center justify-content-between rounded-lg shadow-xs bg-white p-30">
                        <div class="d-flex flex-column">
                            <strong
                                class="font-16 text-dark-blue font-weight-bold"><?php echo e(trans('panel.special_offer')); ?></strong>
                        ...
                        <div class="">
                            ...
                            <div id="offerCountDown" class="d-flex time-counter-down"
                                data-day="<?php echo e($remainingTimes['day']); ?>" data-hour="<?php echo e($remainingTimes['hour']); ?>"
                                data-minute="<?php echo e($remainingTimes['minute']); ?>" data-second="<?php echo e($remainingTimes['second']); ?>">

                                <div class="d-flex align-items-center flex-column mr-10">
                                    <span
                                        class="bg-gray300 rounded p-10 font-16 font-weight-bold text-dark time-item days"></span>
                                    <span class="font-12 mt-1 text-gray"><?php echo e(trans('public.day')); ?></span>
                                </div>
                                <div class="d-flex align-items-center flex-column mr-10">
                                    <span
                                        class="bg-gray300 rounded p-10 font-16 font-weight-bold text-dark time-item hours"></span>
                                    <span class="font-12 mt-1 text-gray"><?php echo e(trans('public.hr')); ?></span>
                                </div>
                                <div class="d-flex align-items-center flex-column mr-10">
                                    <span
                                        class="bg-gray300 rounded p-10 font-16 font-weight-bold text-dark time-item minutes"></span>
                                    <span class="font-12 mt-1 text-gray"><?php echo e(trans('public.min')); ?></span>
                                </div>
                                <div class="d-flex align-items-center flex-column">
                                    <span
                                        class="bg-gray300 rounded p-10 font-16 font-weight-bold text-dark time-item seconds"></span>
            ...
            <div class="col-12 col-lg-8">
                <div class="course-content-body user-select-none">
                    <div class="course-body-on-cover text-white">
                        ...
                        <span class="d-block font-16 mt-10"><?php echo e(trans('public.in')); ?> <a
                                href="<?php echo e($course->category->getUrl()); ?>" target="_blank"
                                class="font-weight-500 text-decoration-underline text-white"><?php echo e($course->category->title); ?></a></span>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ml-10 mt-15 font-14">(<?php echo e($course->reviews->pluck('creator_id')->count()); ?>

                                <?php echo e(trans('public.ratings')); ?>)</span>
                        </div>
                            ...
                            <div class="mt-30 d-flex align-items-center">
                                <div class="progress course-progress flex-grow-1 shadow-xs rounded-sm">
                                    <span class="progress-bar rounded-sm bg-warning"
                                        style="width: <?php echo e($percent); ?>%"></span>
                                </div>
                                ...
                                <span class="ml-15 font-14 font-weight-500">
                                    <?php if($course->isWebinar()): ?>
                                        ...
                                        <?php else: ?>
                                            <?php echo e($course->sales_count); ?>/<?php echo e($course->capacity); ?>

                                            <?php echo e(trans('quiz.students')); ?>
                    ...
                    <div class="<?php if(!$course->isCourse()): ?> mt-35 <?php else: ?> mt-40 pt-40 <?php endif; ?>">
                        <ul class="nav nav-tabs bg-secondary rounded-sm p-15 d-flex align-items-center justify-content-between"
                            ...
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white <?php echo e((empty(request()->get('tab', '')) or request()->get('tab', '') == 'information') ? 'active' : ''); ?>"
                            ...
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white <?php echo e(request()->get('tab', '') == 'content' ? 'active' : ''); ?>"
                            ...
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white <?php echo e(request()->get('tab', '') == 'reviews' ? 'active' : ''); ?>"
                                    id="reviews-tab" data-toggle="tab" href="#reviews" role="tab"
                                    aria-controls="reviews" aria-selected="false"><?php echo e(trans('product.reviews')); ?>

                                    (<?php echo e($course->reviews->count() > 0 ? $course->reviews->pluck('creator_id')->count() : 0); ?>)</a>
                            </li>
                        </ul>
            ...
            <div class="course-content-sidebar col-12 col-lg-4 mt-25 mt-lg-0">
                <div class="rounded-lg shadow-sm">
                    <div class="course-img <?php echo e($course->video_demo ? 'has-video' : ''); ?>">
                        ...
                        <?php if($course->video_demo): ?>
                            <div id="webinarDemoVideoBtn" data-video-path="<?php echo e(config('app_url') . $course->video_demo); ?>"
                    ...
                    <div class="px-20 pb-30">
                                ...
                                <?php $__currentLoopData = $course->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check mt-20">
                                        <input class="form-check-input" <?php if(!$ticket->isValid()): ?> disabled <?php endif; ?>
                                            type="radio"
                                            data-price='<?php echo e(number_format($course->price - ($course->price * $ticket->discount) / 100, 0, ',', '.')); ?><?php echo e($currency); ?>'
                            ...
                            <?php if($course->price > 0): ?>
                                <div id="priceBox" class="d-flex align-items-center justify-content-center mt-20">
                                    <span id="realPrice" data-value="<?php echo e($course->price); ?>"
                                        ...
                                        class="<?php if(!empty($activeSpecialOffer)): ?> font-16 text-gray text-decoration-line-through mr-15 <?php else: ?> font-30 text-primary <?php endif; ?>"><?php echo e(number_format($course->price, 0, ',', '.')); ?><?php echo e($currency); ?></span>
                                    <span id="priceWithDiscount"
                                        class="font-36 text-primary"><?php echo e(!empty($activeSpecialOffer) ? number_format($course->price - ($course->price * $activeSpecialOffer->percent) / 100, 0, ',', '.') . $currency : ''); ?></span>
                                </div>
                            <?php else: ?>
                        ...
                        <div class="mt-40 p-10 rounded-sm border row align-items-center favorites-share-box">
                            ...
                            <div class="col">
                                <a href="/favorites/<?php echo e($course->slug); ?>/toggle" id="favoriteToggle"
                                    class="d-flex flex-column align-items-center text-gray">
                                    <i data-feather="heart" class="<?php echo e(!empty($isFavorite) ? 'favorite-active' : ''); ?>"
                ...
                <div class="rounded-lg shadow-sm mt-35 px-25 py-20">
                    <h3 class="sidebar-title font-16 text-secondary font-weight-bold">
                        <?php echo e(trans('webinars.' . $course->type) . ' ' . trans('webinars.specifications')); ?></h3>
                    ...
                    <div class="mt-30">
                        ...
                        <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                            ...
                            <span
                                class="font-14"><?php echo e(convertMinutesToHourAndMinute(!empty($course->duration) ? $course->duration : 0)); ?>
                        ...
                        <?php if($course->isTextCourse()): ?>
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class="d-flex align-items-center">
                                    <img src="/assets/default/img/icons/sessions.svg" width="20" alt="">
                                    <span
                                        class="ml-5 font-14 font-weight-500"><?php echo e(trans('webinars.text_lessons')); ?>:</span>
                                </div>
                        ...
                        <?php $__currentLoopData = $advertisingBannersSidebar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidebarBanner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="rounded-lg sidebar-ads mt-35 col-<?php echo e($sidebarBanner->size); ?>">
                                <a href="<?php echo e($sidebarBanner->link); ?>">
                                    <img src="<?php echo e($sidebarBanner->image); ?>" class="img-cover rounded-lg"
                                        alt="<?php echo e($sidebarBanner->title); ?>">
                                </a>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <?php $__currentLoopData = $advertisingBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-<?php echo e($banner->size); ?>">
                            <a href="<?php echo e($banner->link); ?>">
                                <img src="<?php echo e($banner->image); ?>" class="img-cover rounded-sm"
        ...
        <form action="/course/<?php echo e($course->id); ?>/report" method="post" class="mt-25">
            ...
            <div class="form-group">
                <label class="text-dark-blue font-14"
                    for="message_to_reviewer"><?php echo e(trans('public.message_to_reviewer')); ?></label>
            ...
            <div class="mt-30 d-flex align-items-center justify-content-end">
                <button type="button"
                    class="js-course-report-submit btn btn-sm btn-primary"><?php echo e(trans('panel.report')); ?></button>
                <button type="button"
                    class="btn btn-sm btn-danger ml-10 close-swl"><?php echo e(trans('public.close')); ?></button>
            </div>
        </form>
    </div>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script src="/assets/default/js/parts/webinar_show.min.js?v=123"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/web/default/course/index.blade.php ENDPATH**/ ?>