                        ...
                        <?php if(!empty($getNetProfitStatistics)): ?>
                            <div class="statistic-details mt-4 position-relative">
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value"><?php echo e($currency.$getNetProfitStatistics['todayIncome']['amount']); ?></div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value"><?php echo e($currency.$getNetProfitStatistics['weekIncome']['amount']); ?></div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value"><?php echo e($currency.$getNetProfitStatistics['monthIncome']['amount']); ?></div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value"><?php echo e($currency.$getNetProfitStatistics['yearIncome']['amount']); ?></div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getTopSellingClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($getTopSellingClass->sales_amount); ?><?php echo e($currency); ?></td>
                                    </tr>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getTopSellingAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingAppointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($getTopSellingAppointment->sales_amount); ?><?php echo e($currency); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
                        </div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getTopSellingTeachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingTeacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($getTopSellingTeacher->sales_amount); ?><?php echo e($currency); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
                        </div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getTopSellingOrganizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingOrganization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($getTopSellingOrganization->sales_amount); ?><?php echo e($currency); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
                        </div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getMostActiveStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getMostActiveStudent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($getMostActiveStudent->total_cost); ?><?php echo e($currency); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/admin/marketing_dashboard.blade.php ENDPATH**/ ?>