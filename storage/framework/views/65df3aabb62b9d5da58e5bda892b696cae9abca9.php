<div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
  ...
  <?php
        $ispartner = !empty($webinarPartnerTeacher);
    ?>
      <?php if($ispartner): ?>
  <span class="user-select-none px-15 py-10 bg-gray200 off-label text-gray text-white font-12 rounded-sm ml-auto"><?php echo e(trans('public.invited')); ?></span>
    ...
    <div class="teacher-avatar mt-5">
        <img src="<?php echo e($courseTeacher->getAvatar()); ?>" class="img-cover" alt="<?php echo e($courseTeacher->full_name); ?>">
...
<?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/course/sidebar_instructor_profile.blade.php ENDPATH**/ ?>