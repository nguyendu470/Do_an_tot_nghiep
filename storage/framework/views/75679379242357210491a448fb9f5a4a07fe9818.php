...
<?php if(!empty($course->files) and $course->files->count() > 0): ?>
    <?php if(!empty($course->chaps) and $course->chaps->count() > 0): ?>
    <section class="mt-20">
        <h2 class="section-title after-line"><?php echo e(trans('public.files')); ?></h2>
        <div class="row">
            <div class="col-12">
                <div class="accordion-content-wrapper mt-15" id="chapAccordion" role="tablist" aria-multiselectable="true">
                    <?php $__currentLoopData = $course->chaps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($chap->files) and $chap->files->count() > 0): ?>
                        <div class="accordion-row rounded-sm shadow-lg border mt-20 p-15">
                            <div class="row align-items-center" role="tab" id="chap_<?php echo e($chap->id); ?>">
                                <div class="col-12 d-flex align-items-center" href="#collapseChap<?php echo e($chap->id); ?>" aria-controls="collapseChap<?php echo e($chap->id); ?>" data-parent="#chapAccordion" role="button" data-toggle="collapse" aria-expanded="true">
                                    <span class="font-weight-bold text-secondary font-14"><?php echo e($chap->title); ?></span>
                                    <div class="icon-position">
                                        
                                    </div>
                                </div>
                            </div>
                            <div id="collapseChap<?php echo e($chap->id); ?>" aria-labelledby="chap_<?php echo e($chap->id); ?>" class=" collapse" role="tabpanel">
                                <div class="panel-collapse">
                                    
                                    <div class="mt-15">
                                        <div class="row">
                                            <div class="col-9 col-md-6 font-12 text-gray"><span class="pl-10"><?php echo e(trans('public.title')); ?></span></div>
                                            <div class="col-md-3 font-12 text-gray text-center d-none d-md-block">Thông tin</div>
                                            <div class="col-3"></div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="accordion-content-wrapper mt-15" id="filesAccordion" role="tablist" aria-multiselectable="true">
                                                    <?php $__currentLoopData = $chap->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="accordion-row rounded-sm shadow-lg border mt-20 p-15">
                                                            <div class="row align-items-center" role="tab" id="files_<?php echo e($file->id); ?>">
                                                                <div class="col-9 col-md-6 d-flex align-items-center" href="#collapseFiles<?php echo e($file->id); ?>" aria-controls="collapseFiles<?php echo e($file->id); ?>" data-parent="#filesAccordion" role="button" data-toggle="collapse" aria-expanded="true">
                                                                    ...
                                                                    <?php if($file->accessibility == 'paid'): ?>
                                                                        <?php if(!empty($user) and $hasBought): ?>
                                                                            <a href="<?php echo e($course->getUrl()); ?>/lessons/<?php echo e($file->id); ?>/watch" target="_blank" class="mr-15" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('public.read')); ?>">
                                                                ...
                                                                <div class="col-3 d-flex justify-content-end">
                                                                    <?php if($file->accessibility == 'paid'): ?>
                                                                        <?php if(!empty($user) and $hasBought): ?>
                                                                            <a href="<?php echo e($course->getUrl()); ?>/lessons/<?php echo e($file->id); ?>/watch" target="_blank" class="course-content-btns btn btn-sm btn-primary flex-grow-1">
...
<?php if(!empty($course->textLessons) and $course->textLessons->count() > 0): ?>
    ...
    <section class="mt-20">
        ...
        <div class="row">
            <div class="col-12">
                <div class="accordion-content-wrapper mt-15" id="chapAccordionLessons" role="tablist" aria-multiselectable="true">
                    <?php $__currentLoopData = $course->chaps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($chap->textLessons) and $chap->textLessons->count() > 0): ?>
                        <div class="accordion-row rounded-sm shadow-lg border mt-20 p-15">
                            <div class="row align-items-center" role="tab" id="chapLessons_<?php echo e($chap->id); ?>">
                                <div class="col-12 d-flex align-items-center" href="#collapseChapLessons<?php echo e($chap->id); ?>" aria-controls="collapseChapLessons<?php echo e($chap->id); ?>" data-parent="#chapAccordionLessons" role="button" data-toggle="collapse" aria-expanded="true">
                                    <span class="font-weight-bold text-secondary font-14"><?php echo e($chap->title); ?></span>
                                    <div class="icon-position">
                            ...
                            <div id="collapseChapLessons<?php echo e($chap->id); ?>" aria-labelledby="chapLessons_<?php echo e($chap->id); ?>" class=" collapse" role="tabpanel">
                                <div class="panel-collapse">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="accordion-content-wrapper mt-15" id="textLessonsAccordion" role="tablist" aria-multiselectable="true">
                                                    <?php $__currentLoopData = $chap->textLessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $textLesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="accordion-row rounded-sm shadow-lg border mt-20 p-15">
...
<?php endif; ?>
<?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/course/tabs/content.blade.php ENDPATH**/ ?>