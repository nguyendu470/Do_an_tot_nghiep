        ...
        <div class="mt-40">
            ...
            <div class="mt-20 d-flex align-items-center">
                <?php $__currentLoopData = $occupations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $occupation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-gray200 font-14 rounded px-10 py-5 text-gray mr-15"><?php echo e($occupation->category->title); ?></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    <?php endif; ?>
...
<?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/user/profile_tabs/about.blade.php ENDPATH**/ ?>