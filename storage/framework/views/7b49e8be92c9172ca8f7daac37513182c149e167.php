                    ...
                    <div class="card">
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_offline_payments_export_excel')): ?>
                                <a href="/admin/financial/offline_payments/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
                            <?php endif; ?>
                        </div>
                                    ...
                                    <?php if($offlinePayments->count() > 0): ?>
                                        <?php $__currentLoopData = $offlinePayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offlinePayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($currency .''. $offlinePayment->amount); ?></td>

                                                <td><?php echo e($offlinePayment->bank); ?></td>
                                                ...
                                                <td><?php echo e(dateTimeFormat($offlinePayment->pay_date, 'Y/m/j-H:i')); ?></td>
                        ...
                        <div class="card-footer text-center">
                            <?php echo e($offlinePayments->links()); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/admin/financial/offline_payments/lists.blade.php ENDPATH**/ ?>