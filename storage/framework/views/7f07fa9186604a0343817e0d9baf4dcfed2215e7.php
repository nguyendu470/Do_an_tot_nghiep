<div class="tab-pane fade <?php if(!empty(request()->get('page'))): ?> active show <?php endif; ?>" id="payment_channels" role="tabpanel" aria-labelledby="payment_channels-tab">
    <div class="card">
        ...
        <div class="card-footer text-center">
            <?php echo e($paymentChannels->links()); ?>

        </div>

    </div>
</div>
<?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/settings/financial/payment_channel/lists.blade.php ENDPATH**/ ?>