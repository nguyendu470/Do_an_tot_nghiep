...
<div class="d-none" id="webinarFileModal">
    ...
    <form action="/admin/files/store" method="post">
        ...
        <div class="form-group">
            <label class="input-label">Chương</label>
            <select class="custom-select" name="chap_id" required>
                <option selected disabled>Chọn chương</option>
                <?php $__currentLoopData = \DB::table('chapter')->where('webinar_id',$webinar->id??0)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-group">
            <label class="input-label">Hoặc nhập chương mới ở đây</label>
            <input type="text" name="title_chap" class="form-control" placeholder="Nhập tiêu đề chương"/>
            <div class="invalid-feedback"></div>
        </div>
        <div class="form-group">
        ...
        <div class="online-inputs form-group d-none">
            ...
            <div class="row mt-2">
                ...
                <div class="col-6">
                    <label class="input-label">Thông tin</label>
...
<?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/admin/webinars/modals/file.blade.php ENDPATH**/ ?>