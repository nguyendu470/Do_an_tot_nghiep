                                    ...
                                    <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <input type="hidden" class="report-reason" value="<?php echo nl2br($report->reason); ?>">
                                                <input type="hidden" class="report-description" value="<?php echo nl2br($report->message); ?>">
                                            </td>

                                            <td class="text-center"><?php echo e(dateTimeFormat($report->created_at, 'Y M j | H:i')); ?></td>

                                            <td width="150px" class="text-right">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_webinar_reports_delete')): ?>
                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/reports/webinars/'.$report->id.'/delete','btnClass' => 'btn-sm'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/webinars/reports.blade.php ENDPATH**/ ?>