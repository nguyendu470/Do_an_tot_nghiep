                                                    ...
                                                    <div class="col-12 col-md-6 js-start_date <?php echo e((!empty(old('type')) and old('type') != \App\Models\Webinar::$webinar) ? 'd-none' : ''); ?>">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="start_date" value="<?php echo e((!empty($webinar) and $webinar->start_date) ? dateTimeFormat($webinar->start_date,'Y-m-d') : old('start_date')); ?>" class="form-control <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> datepicker" aria-describedby="dateInputGroupPrepend"/>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if(!empty($webinar)): ?>
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h2 class="section-title after-line">Danh sách chương</h2>
                                            <button id="webinarAddChap" type="button" class="btn btn-primary btn-sm mt-3">Tạo mới chương</button>
                                        </div>

                                        <div class="row mt-10">
                                            <div class="col-12">
                                                <?php if(!empty($chapers) and !$chapers->isEmpty()): ?>
                                                    <div class="table-responsive">
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $chapers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    <th><?php echo e($chap->title); ?></th>

                                                                    <td>
                                                                        <button type="button" data-chap-id="<?php echo e($chap->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-chap btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/files/'. $chap->id .'/delete_chap', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="webinarAddFile" type="button" class="btn btn-primary btn-sm mt-3 mr-3"><?php echo e(trans('public.add_files')); ?></button>
                                            <button id="webinarImportAddFile" type="button" class="btn btn-primary btn-sm mt-3 mr-3">Import tập tin</button>
                                        </div>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <th><?php echo e($file->chap()->first()->title??"--"); ?></th>
                                    ...
                                    <?php if($webinar->isTextCourse()): ?>
                                        <section class="mt-30">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <button id="webinarAddTestLesson" type="button" class="btn btn-primary btn-sm mt-3 mr-3"><?php echo e(trans('public.add_test_lesson')); ?></button>
                                                <button id="webinarImportAddTestLesson" type="button" class="btn btn-primary btn-sm mt-3">Import bài giảng</button>
                                            </div>
                                                            ...
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                <?php $__currentLoopData = $textLessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $textLesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        ...
                                                                        <th><?php echo e($textLesson->chap()->first()->title??"--"); ?></th>
                            ...
                            <?php echo $__env->make('admin.webinars.modals.chap', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('admin.webinars.modals.importFile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('admin.webinars.modals.importText', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script src="/assets/admin/js/webinar.min.js?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/admin/webinars/create.blade.php ENDPATH**/ ?>