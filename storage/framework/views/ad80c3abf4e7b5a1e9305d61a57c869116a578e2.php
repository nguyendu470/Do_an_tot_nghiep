                        ...
                        <form action="/cart/store" method="post">
                            ...
                            <?php if(!empty($course->tickets)): ?>
                                <?php $__currentLoopData = $course->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-check mt-20">
                                        <input class="form-check-input" <?php if(!$ticket->isValid()): ?> disabled <?php endif; ?> type="radio" data-price='<?php echo e(number_format($course->price - ($course->price * $ticket->discount / 100),0,",",".")); ?><?php echo e($currency); ?>' data-discount="<?php echo e($ticket->discount); ?>" value="<?php echo e(($ticket->isValid()) ? $ticket->id : ''); ?>"
                                               name="ticket_id"
                            ...
                            <?php if($course->price > 0): ?>
                                <div id="priceBox" class="d-flex align-items-center justify-content-center mt-20">
                                    ...
                                    <span id="priceWithDiscount" class="font-36 text-primary"><?php echo e(!empty($activeSpecialOffer) ? (number_format($course->price - ($course->price * $activeSpecialOffer->percent / 100),0,",",".")).$currency : ''); ?></span>
                                </div>
                            <?php else: ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/course/index.blade.php ENDPATH**/ ?>