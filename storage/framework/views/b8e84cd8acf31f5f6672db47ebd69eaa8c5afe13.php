                        ...
                        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" value="<?php echo nl2br($review->description); ?>">
                                </td>
                                ...
                                <td class="" width="50">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_reviews_status_toggle')): ?>
                                        <a href="/admin/reviews/<?php echo e($review->id); ?>/toggleStatus" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(($review->status == 'active') ? 'Hidden' : 'Publish'); ?>">
                                            <?php if($review->status == 'active'): ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_reviews_delete')): ?>
                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/reviews/'. $review->id.'/delete','btnClass' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/reviews/lists.blade.php ENDPATH**/ ?>