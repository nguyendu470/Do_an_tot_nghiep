                    ...
                    <div class="row">
                        <?php $__currentLoopData = $webinars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6 col-lg-4 mt-30">
                                <?php echo $__env->make(getTemplate() . '.includes.webinar.grid-card', [
                                    'webinar' => $webinar,
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-6 col-md-3 col-lg-2 mt-30">
                                <div
                                    class="user-search-card text-center d-flex flex-column align-items-center justify-content-center">
                                    <div class="user-avatar">
                                        <img src="<?php echo e($teacher->getAvatar()); ?>" class="img-cover rounded-circle"
                                            alt="<?php echo e($teacher->full_name); ?>">
                                    </div>
                                    <a href="<?php echo e($teacher->getProfileUrl()); ?>">
                                        <h4 class="font-16 font-weight-bold text-dark-blue mt-10"><?php echo e($teacher->full_name); ?>
                            ...
                            <div class="col-md-6 col-lg-3 mt-30">
                                <a href="<?php echo e($organization->getProfileUrl()); ?>"
                                    ...
                                    <div class="home-organizations-avatar">
                                        <img src="<?php echo e($organization->getAvatar()); ?>" class="img-cover rounded-circle"
                                    ...
                                    <div class="mt-25 d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <span
                                            class="home-organizations-badge badge mt-15"><?php echo e($organization->getActiveWebinars(true)); ?>

                                            <?php echo e(trans('product.courses')); ?></span>
                                    </div>
                                </a>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/web/default/pages/search.blade.php ENDPATH**/ ?>