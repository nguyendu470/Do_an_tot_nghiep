                ...
                <div class="login-card">
                    ...
                    <form method="Post" action="/become_instructor" class="mt-35">
                        ...
                        <div class="form-group">
                            <label class="font-weight-500 text-dark-blue"><?php echo e(trans('site.occupations')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label class="input-label"><?php echo e(trans('site.extra_information')); ?></label>
                        ...
                        <button type="submit" class="btn btn-primary btn-block mt-20"><?php echo e(trans('site.send_request')); ?></button>
                    </form>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/web/default/user/become_instructor.blade.php ENDPATH**/ ?>