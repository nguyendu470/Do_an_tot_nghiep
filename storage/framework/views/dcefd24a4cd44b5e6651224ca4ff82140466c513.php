                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(dateTimeFormat($comment->created_at, 'Y M j | H:i')); ?></td>
                                            <td class="text-left">
                                            ...
                                            <td width="150px" class="text-center">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_'. $itemRelation .'_comments_status')): ?>
                                                    <a href="/admin/comments/<?php echo e($page); ?>/<?php echo e($comment->id); ?>/toggle" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.'.(($comment->status == 'pending') ? 'publish' : 'pending'))); ?>">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_'. $itemRelation .'_comments_reply')): ?>
                                                    <a href="/admin/comments/<?php echo e($page); ?>/<?php echo e(!empty($comment->reply_id) ? $comment->reply_id : $comment->id); ?>/reply" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.reply')); ?>">
                                                        <i class="fa fa-reply"></i>
                                                    </a>
                                                <?php endif; ?>

                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_'. $itemRelation .'_comments_edit')): ?>
                                                    <a href="/admin/comments/<?php echo e($page); ?>/<?php echo e($comment->id); ?>/edit" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vnedumall.com/public_html/resources/views/admin/comments/comments.blade.php ENDPATH**/ ?>