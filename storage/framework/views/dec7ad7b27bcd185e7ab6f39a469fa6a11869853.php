                    ...
                    <?php if(!empty($getIncomeStatistics)): ?>
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                ...
                                <div class="card-stats-items">
                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e($currency); ?><?php echo e($getIncomeStatistics['todaySales']); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('admin/main.today')); ?></div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e($currency); ?><?php echo e($getIncomeStatistics['monthSales']); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('admin/main.this_month')); ?></div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e($currency); ?><?php echo e($getIncomeStatistics['yearSales']); ?></div>
                                    ...
                                    <?php if(!empty($getMonthAndYearSalesChartStatistics)): ?>
                                        <div class="statistic-details mt-4 position-relative">
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-value"><?php echo e($currency.$getMonthAndYearSalesChartStatistics['todaySales']['amount']); ?></div>
                                            ...
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-value"><?php echo e($currency.$getMonthAndYearSalesChartStatistics['weekSales']['amount']); ?></div>
                                            ...
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-value"><?php echo e($currency.$getMonthAndYearSalesChartStatistics['monthSales']['amount']); ?></div>
                                            ...
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-value"><?php echo e($currency.$getMonthAndYearSalesChartStatistics['yearSales']['amount']); ?></div>
                                ...
                                <?php $__currentLoopData = $recentComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recentComment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="float-right text-primary font-12"><?php echo e(dateTimeFormat($recentComment->created_at, 'Y M j | H:i')); ?></div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-hero">
                            <div class="card-header">
                                ...
                                <div class="card-description"><?php echo e($recentTickets['pendingReply']); ?> Pending Reply</div>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>