...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-30 d-flex align-items-center justify-content-between">
            <label class="cursor-pointer input-label" for="supportSwitch"><?php echo e(trans('webinars.supported_class')); ?></label>
        ...
        <div id="partnerInstructorInput" class="form-group mt-15 <?php echo e(!empty($webinar) && $webinar->partner_instructor ? '' : 'd-none'); ?>">
            ...
            <select name="partners[]" class="form-control panel-search-user-select2" multiple="" data-search-option="just_teachers" data-placeholder="<?php echo e(trans('public.search_instructor')); ?>">
            ...
            <div class="text-gray font-12 mt-1"><?php echo e(trans('admin/webinars.partner_Teacher_hint')); ?></div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/panel/webinar/create_includes/step_2.blade.php ENDPATH**/ ?>