        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="<?php echo e($siteGeneralSettings['logo'] ?? ''); ?>" alt="logo" width="40%"
                            class="mb-5 mt-2">

                        <h4 class="text-dark font-weight-normal"><?php echo e(trans('auth.welcome')); ?> <span
                                class="font-weight-bold"><?php echo e($siteGeneralSettings['site_name'] ?? ''); ?>

                                <?php echo e(trans('auth.admin_panel')); ?></span></h4>
                        ...
                        <form method="POST" action="<?php echo e(url('/admin/login')); ?>" class="needs-validation" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email" value="<?php echo e(old('email')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    data-background="<?php echo e($getPageBackgroundSettings['admin_login'] ?? ''); ?>">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-2 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold">EduChamp</h1>
                                <h5 class="font-weight-normal text-muted-transparent">nền tảng giáo dục đầy đủ tính năng
                                </h5>
                            </div>
...
<?php /**PATH E:\Đồ_Án_Tốt_Nghiệp_NGUYENVANDU\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>