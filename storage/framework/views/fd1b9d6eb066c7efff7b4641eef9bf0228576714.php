<?php $__env->startSection('content'); ?>
    <section>
        ...
        <?php if(!empty($notifications) and !$notifications->isEmpty()): ?>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-3 mt-10 mt-lg-0 d-flex align-items-start">
                            ...
                            <div class="">
                                ...
                                <span class="notification-time d-block font-12 text-gray mt-5"><?php echo e(dateTimeFormat($notification->created_at,'Y M j | H:i')); ?></span>
                            </div>
                        </div>
            ...
            <div class="my-30">
                <?php echo e($notifications->links('vendor.pagination.panel')); ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nguyen Du\Downloads\backup-vnedumall.com-07.18.2022_02-32-41\public_html\old\resources\views/web/default/panel/notifications/index.blade.php ENDPATH**/ ?>